...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_category" AS ENUM('news', 'opinion', 'essays');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'review', 'published', 'archived');
  ...
  CREATE TABLE "posts" (
  	...
  	"category" "enum_posts_category" DEFAULT 'news' NOT NULL,
